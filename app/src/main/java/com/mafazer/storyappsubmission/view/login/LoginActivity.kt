...
import com.mafazer.storyappsubmission.databinding.ActivityLoginBinding
import com.mafazer.storyappsubmission.view.ViewModelFactory
import com.mafazer.storyappsubmission.view.main.MainActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.loginResult.observe(this) { user ->
            AlertDialog.Builder(this).apply {
                ...
                setMessage(getString(R.string.welcome, user.email))
